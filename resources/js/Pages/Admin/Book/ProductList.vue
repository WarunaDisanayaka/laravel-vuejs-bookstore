...
const store_id = usePage().props.store_id;
...
const openEditModal = (product, index) => {
    ...
    isbn.value = product.isbn || '';
    edition.value = product.edition || '';
    number_of_pages.value = product.number_of_pages || '';
...
const AddProduct = async () => {
    ...
    formData.append('number_of_pages', number_of_pages.value);
    // end
...
<template>
    <section class="  p-3 sm:p-5">
        ...
        <el-dialog v-model="dialogVisible" :title="editMode ? 'Edit product' : 'Add Book'" width="30%"
            ...
            <form @submit.prevent="editMode ? updateProduct() : AddProduct()">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input v-model="publisher" type="text" name="floating_publisher" id="floating_publisher"
                           class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                           placeholder=" " />
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input v-model="isbn" type="text" name="floating_isbn" id="floating_isbn"
                           class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                           placeholder=" " />
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input v-model="edition" type="text" name="floating_edition" id="floating_edition"
                           class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                           placeholder=" " />
                    <label for="floating_edition"
                           class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Edition</label>
                </div>

                <div class="relative z-0 w-full mb-6 group">
                    <input v-model="number_of_pages" type="number" name="floating_number_of_pages" id="floating_number_of_pages"
                           class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                           placeholder=" " />
                    <label for="floating_number_of_pages"
