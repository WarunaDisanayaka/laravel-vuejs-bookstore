...
<!--                    </button>-->
                    <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                        <li>
                            <Link :href="route('manager.products.index')"
...
<!--                                  class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">User roles</Link>-->
<!--                        </li>-->
<!--                        <li>-->
<!--                            <Link :href="route('admin.stores.index')"-->
<!--                                  class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Stores</Link>-->
<!--                        </li>-->
<!--                        <li>-->
<!--                            <Link :href="route('admin.orders.index')"-->
<!--                                  class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Orders</Link>-->
<!--                        </li>-->
                    </ul>
                </li>
            </ul>
            <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                <li>
                    <a :href="route('accountant.orders.export')"
                       download="sale_report.xlsx"
