...
const openAddModal = () => {
    ...
    resetFormData(); // Add this line to reset form data
}


// Add user method
const addRole = async () => {
    console.log('addRole method called');
    ...
    try {
        await router.post('roles/store', formData, {
            onSuccess: page => {
                Swal.fire({
                    toast: true,
                    icon: 'success',
...
<template>
    <section class="  p-3 sm:p-5">
        ...
        <el-dialog v-model="dialogVisible" :title="editMode ? 'Edit product' : 'Add User'" width="30%" :before-close="handleClose">
            <!-- form start -->
            <form @submit.prevent="editMode ? updateProduct() : addRole()">
                <div class="relative z-0 w-full mb-6 group">
                    <input v-model="userRole" type="text" name="floating_role" id="floating_role"
